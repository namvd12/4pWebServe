...
-- Dumping structure for table 4p_db.tula_table5
CREATE TABLE IF NOT EXISTS `tula_table5` (
  ...
  KEY `FK_tula_table5_tula_table1` (`tula1`),
  CONSTRAINT `FK_tula_table5_tula_table1` FOREIGN KEY (`tula1`) REFERENCES `tula_table1` (`tula_Key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table 4p_db.tula_table5: ~0 rows (approximately)
